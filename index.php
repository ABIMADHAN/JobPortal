      ...
      <div class="hero-content">
        ...
        <div class="stats-grid">
          ...
          <div>
            ...
            <div class="label-sm text-variant" style="margin-top: 4px;">Updated <span
                id="live-updated"><?= date('g:i:s A') ?></span></div>
          </div>
        </div>
      </div>
        ...
        <div class="dashboard-card soft-shadow">
          ...
          <div class="dash-stats">
            <div class="stat-box hover-lift">
              ...
              <div class="label-sm" style="color: var(--success); display: flex; align-items: center; margin-top: 4px;">
